...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-polis/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-polis -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-polis -o bitcore-lib-polis.js';
    }
